...
public class suspectAdapter extends RecyclerView.Adapter<suspectAdapter.myViewHolder>{
    ...
    public void onBindViewHolder(@NonNull myViewHolder holder, int position) {
        ...
        boolean isExpandable = sus_list.get(position).isExpandable();
            ...
            try {
                linearLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        suspect_registered currentSus = sus_list.get(getAdapterPosition());
                        currentSus.setExpandable(!currentSus.isExpandable());
