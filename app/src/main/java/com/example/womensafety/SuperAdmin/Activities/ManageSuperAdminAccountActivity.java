...
import com.example.womensafety.Activities.OtpVerification;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.superadmin_manage_users:
                        startActivity(new Intent(ManageSuperAdminAccountActivity.this, SuperAdminUsersActivity.class));
                        break;
                    ...
                    case R.id.superadmin_settings:
                        startActivity(new Intent(ManageSuperAdminAccountActivity.this, SuperAdminSettingsActivity.class));
                        break;
