...
public class AdminHomepageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.admin_manage_users:
                        startActivity(new Intent(AdminHomepageActivity.this,AdminUserActivity.class));
                        break;
                    case R.id.admin_settings:
                        final Intent intent=new Intent(AdminHomepageActivity.this, SuperAdminSettingsActivity.class);
                        intent.putExtra("flag","1");
                        startActivity(new Intent(AdminHomepageActivity.this, SuperAdminSettingsActivity.class));
                        break;
        ...
        adapter = new SuperAdminPostAdapter(AdminHomepageActivity.this, mList);
        ...
        super_admin_post_rec.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (isBottom)
                    Toast.makeText(AdminHomepageActivity.this, "no more posts to show", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        listenerRegistration = query.addSnapshotListener(AdminHomepageActivity.this, new EventListener<QuerySnapshot>() {
            @Override
