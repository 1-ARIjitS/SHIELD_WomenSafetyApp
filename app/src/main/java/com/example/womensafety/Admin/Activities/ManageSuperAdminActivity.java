            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.superadmin_manage_users:
                        startActivity(new Intent(ManageSuperAdminActivity.this, AdminUserActivity.class));
                        break;
                    case R.id.superadmin_settings:
                        startActivity(new Intent(ManageSuperAdminActivity.this, AdminSettingsActivity.class));
                        break;
